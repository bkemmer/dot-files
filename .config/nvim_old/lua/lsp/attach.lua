...
M.on_attach = function(client, bufnr)
    ...
    vim.keymap.set("n", "gty", vim.lsp.buf.type_definition, keymapOptions("Go to type definition"))
    vim.keymap.set("n", "<leader>r", vim.lsp.buf.rename, keymapOptions("Rename symbol"))
