...
local   keymaps = {
    ...
    { "<leader>gp", function() Snacks.picker.git_diff() end, desc = "[G]it Diff [p]icker (Hunks)" },
    { "<leader>gP", function() Snacks.picker.git_diff({ base = "origin" }) end, desc = "[G]it Diff [P]icker(origin)" },
    ...
    { "<leader>sw", function() Snacks.picker.grep_word() end, desc = "Visual [s]election or [w]ord", mode = { "n", "x" } },
    -- search
