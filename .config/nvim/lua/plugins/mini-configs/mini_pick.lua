...
km.set("n", "<leader>ps", "<cmd>Pick lsp scope='document_symbol'<cr>", { desc = "document symbols" })
km.set("n", "<leader>pS", "<cmd>Pick lsp scope='workspace_symbol'<cr>", { desc = "workspace symbols" })
km.set("n", "<leader>pf", "<cmd>Pick files<cr>", { desc = "files" })
km.set("n", "<leader>pg", "<cmd>Pick git_files<cr>", { desc = "git files" })
...
km.set("n", "<Leader>pv", "<cmd>Pick visted paths<cr>", { desc = "Open Mini Pick for visited paths ordered by robust frecency" })
